export function applyHeaderTranslations(translations) {
    const elements = {
        ...
        managementBoardBtn: document.querySelector('#ManagementBoardBtn'),
    ...
    if (elements.managementBoardBtn) elements.managementBoardBtn.textContent = translations.Header.ManagementBoardBtn;
